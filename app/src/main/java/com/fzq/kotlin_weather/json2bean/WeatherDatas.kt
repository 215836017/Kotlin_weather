...
data class Daily_forecast(val cond_code_d: String, val cond_code_n: String, val cond_txt_d: String,
                          val cond_txt_n: String, val date: Date, val hum: String, val pcpn: String, val pop: String,
                          ...
                          val wind_spd: String)
// weather/now -- 实时天气
data class WeatherNow(val heWeather6: List<com.fzq.kotlin_weather.json2bean.now.HeWeather6>)

data class Basic(val cid: String, val location: String,val parent_city: String, val admin_area: String,
                val cnty: String, val lat: String, val lon: String, val tz: String )
...
data class Update(val loc: Date, val utc: Date)
...
data class Hourly(val cloud: String, val cond_code: String, val cond_txt: String, val hum: String,
                  val pop: String, val pres: String, val time: Date, val tmp: String,
